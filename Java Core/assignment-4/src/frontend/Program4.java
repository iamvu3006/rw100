...
public class Program4 {
    public static void main(String[] args) {
        ...
        System.out.println("Câu 10: Kết quả kiểm tra đảo ngược: " + (exercise.question10AreReverseStrings(q10s1, q10s2) ? "Đúng" : "Không đúng"));
        ...
        if (split == null) {
            System.out.println("Câu 16: Kết quả: Không hợp lệ");
        } else {
