...
public class Program6 {
    public static void main(String[] args) {
        ...
        System.out.println("Câu 2: Tiếp tục nhập khi trả lời 'Y': " + exercise.question2ShouldContinueAdding("Y"));
        System.out.println("Câu 2: Tiếp tục nhập khi trả lời 'N': " + exercise.question2ShouldContinueAdding("N"));
    }
}
