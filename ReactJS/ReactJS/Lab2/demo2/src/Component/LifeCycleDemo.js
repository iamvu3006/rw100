...
class LifeCycleDemo extends Component {
  ...
  changeState = () => {
    ...
    console.log("Bước 1: Sau khi click nút Change thì gọi tới phương thức: Change State");
  };
  render() {
  ...
  shouldComponentUpdate(newProps, newState) {
    ...
    console.log("Bước 2: Gọi tới ShouldComponentUpdate, Nếu kết quả là true thì thực hiện tiếp bước bên dưới để thực hiện render lại: " + true);
